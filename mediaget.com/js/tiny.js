...
(function($){
	$.fn.tinycarousel = function(options){
		...
		function cobra(){
                     if(options.controls){
                      if( iCurrent == 0 ){
                      $(".showLeft").css({visibility:'hidden'});
                      $(".showRight").css({visibility:'visible'});
                      }
                      if( iCurrent == 1 ){
                       $(".showLeft,.showRight").css({visibility:'visible'});
                      }
                      if( iCurrent == 2 ){    
                       $(".showRight").css({visibility:'hidden'});
                       $(".showLeft").css({visibility:'visible'});
                      } 
                     }
                    }
